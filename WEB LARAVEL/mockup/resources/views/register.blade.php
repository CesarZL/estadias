                        ...
                        <form class="space-y-4 md:space-y-6" action="#">
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-3 text-sm">
                                  <label for="terms" class="font-light text-gray-500 dark:text-gray-300">E leído y Acepto los <a class="font-medium text-purple-600 hover:underline dark:text-purple-500" href="#">términos y condiciones</a></label>
                                </div>
                            </div>
                            <a type="submit" href="/" class="w-full text-white bg-purple-600 hover:bg-purple-700 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800">Crear cuenta</a>
                            <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                                ¿Ya tienes una cuenta? <a href="/" class="font-medium text-purple-600 hover:underline dark:text-purple-500">Inicia sesión</a>
                            </p>
                        </form>
                    </div>
                </div>
